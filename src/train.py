...
def main(cfg: DictConfig) -> None:
    ...
    # тратит РАЗНОЕ его количество у разных конфигураций: гейт входа — это два nn.Linear
    # на 627 тысяч параметров, инициализируемых до того, как выходной слой
    # зануляется. Без пересева гейтованная конфигурация при том же сиде видит другую
    ...
    # контрастом «сид A против сида B» стохастического потока, и различие конфигураций
    ...
    if patience > 0 and val_loader is not None:
        ...
        # величине, которая между конфигурациями просто не сравнима (у многочленных
